...
export const HallManagement = () => {
  ...
  const handleActionClick = useCallback(
    (action: "disable" | "block" | "temporaryBlock" | "reserve" | "clear") => {
      ...
      switch (action) {
        case "disable":
          setDisabledSeats(updateStatus(disabledSeats, true));
          break;
        case "block":
          setBlockedSeats(updateStatus(blockedSeats, true));
          break;
        case "temporaryBlock":
          setTempBlockedSeats(updateStatus(tempBlockedSeats, true));
          break;
        case "reserve":
          setReservedSeats(updateStatus(reservedSeats, true));
          break;
        case "clear":
          setDisabledSeats(updateStatus(disabledSeats, false));
          setBlockedSeats(updateStatus(blockedSeats, false));
          setTempBlockedSeats(updateStatus(tempBlockedSeats, false));
          setReservedSeats(updateStatus(reservedSeats, false));
          break;
      }
    },
    [
  ...
  // Настройка IntersectionObserver для фиксации меню
  // useEffect(() => {
